...
import { IDepositRequest } from '../../data-access/IDepositRequest'
import { InputDropdownComponent } from '../../ui/input-dropdown/input-dropdown.component'

@Component({
  selector: 'app-dashboard-deposit',
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
  ...
  templateUrl: './dashboard-deposit.component.html',
  styleUrl: './dashboard-deposit.component.scss'
})
export class DashboardDepositComponent {
  ...
  public submit() {
    ...
    this.paymentService.deposit(depositRequest)
      .subscribe(() => {
